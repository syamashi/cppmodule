...
/*   Updated: 2021/06/18 12:57:40 by syamashi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void NinjaTrap::ninjaShoebox(ClapTrap &crap)
{
	if (this->Energy_points < 25)
	{
		std::cout << this->Name << " tried to attck " << crap.get_Name() << ". but not enough EP!!"
	...
	int skillsize = 5;
	std::cout << "N1NJ-TP " << this->Name << " attacks " << crap.get_Name() << " \"" << ninjas[rand() % skillsize] << "!!\" causing " << this->Melee_attack_damage << " points of damage!"
	 << " ([EP] " << this->Energy_points << " / " << this->Max_energy_points << ")" << std::endl;
	crap.takeDamage(this->Melee_attack_damage);
}
